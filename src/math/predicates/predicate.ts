...
/**
 * A predicate is a shorthand string representation of an indicator function [1]. In practical terms, a predicate may be
 * thought of as a simplified regular expression, with particular focus on:
