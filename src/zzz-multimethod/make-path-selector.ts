 ...
 */
export default function makePathSelector(taxonomy: Taxonomy, candidates: Map<Pattern, PathHandler>): PathSelector {
...
/** A RouteSelector function takes a discriminant string and returns the best-matching route handler for it. */
export type PathSelector = (discriminant: string) => PathHandler;
