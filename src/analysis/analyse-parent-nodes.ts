...
import {PredicateInMethodTable, ExactlyMatchingMethods, ParentNode} from './mm-node';
...
export default function analyseParentNodes<T extends PredicateInMethodTable & ExactlyMatchingMethods>(mminfo: MMInfo<T>) {
