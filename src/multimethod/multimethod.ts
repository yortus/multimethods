...
// const arities: [1, 2, 3, 'variadic', undefined] = [1, 2, 3, 'variadic', undefined];
// const arityNames = ['Unary', 'Binary', 'Ternary', 'Variadic', ''];
// let classInstanceTrackers = arities.map(() => new WeakSet());
// let classNames = arityNames.map(name => name + 'Multimethod');
// let classConstructors = classNames.map((className, i) => {
...
// ctor MM  --> put in mmset AND mmset
// ctor UMM --> put in ummset AND mmset

// is MM  iff in mmset
// is UMM iff in ummset


// class $NAME {
//     constructor(options) { return addInstance(this, createMultimethod(patchOptions(options, 2))); }
//     static [Symbol.hasInstance](value: any) { return hasInstance(this, value); }
// };


// function patchOptions(options: MultimethodOptions, arity: number): MultimethodOptions {
//     return Object.assign({}, options, {arity});
// }
// function addInstance<T>(constructor: any, instance: T): T {
//     let instances: WeakSet<any> = constructor.instances || (constructor.instances = new WeakSet());
//     instances.add(instance);
//     return instance;
// }
// function hasInstance(constructor: any, instance: any): boolean {
//     let instances: WeakSet<any> = constructor.instances || (constructor.instances = new WeakSet());
//     return instances.has(instance);
// }
// const allInstances = new WeakSet();
...
// function mapObject<T, U>(obj: {[k: string]: T}, callback: (val: T, key: string) => U): {[k: string]: U} {
//     return Object.keys(obj).reduce((newObj, key) => (newObj[key] = callback(obj[key]), newObj), {});
// }
...
function createMultimethod(arity: Arity, options: MultimethodOptions): Multimethod {
    // TODO: ...
    return <any> {};
}


function getClassNameForArity(arity: 1 | 2 | 3 | 'variadic' | undefined) {
    switch (arity) {
        case 1: return 'UnaryMultimethod';
        case 2: return 'BinaryMultimethod';
        case 3: return 'TernaryMultimethod';
        case 'variadic': return 'VariadicMultimethod';
        default: return 'Multimethod';
    }
}
