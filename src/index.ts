...
export {default as PredicateClass, parsePredicatePattern, PredicatePatternAST, parse, makeIdentifier, makeMatchFunction, intersect, normalise, ANY} from './predicate';
